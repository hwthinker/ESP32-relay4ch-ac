...
![](https://github.com/hwthinker/ESP32-relay4ch-ac/blob/main/picture/1.png)


## Cara download dengan Serial USB biasa
![](https://github.com/hwthinker/ESP32-relay4ch-ac/blob/main/picture/2.png)
...
![](https://github.com/hwthinker/ESP32-relay4ch-ac/blob/main/picture/3.png)
- Pasang serial USB TTL dengan ketentuan:
    - RX -> RX USB Serial  
    - TX -> TX USB Serial 
    - GND -> GND USB Serial  
